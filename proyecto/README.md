...
- La presentacion tipo powerpoint debe incluir 1) introduccion, 2) reimagenes del estado del arte, 3) el metodo propuesto en detalle (con un diagrama de bloques claro con todos los pasos y resultados intermedios), 4) resultados obtenidos, 5) conclusiones y 6) demo.
